...
source("scripts/check_for_install_deps.R",echo = T) 
...
kable(o['K1'])
write.table(o$K1[,c(1,8)], "gene_lists/K1.forREVIGO.txt",quote=F,col.names=F,row.names=F)
kable(o['K2'])
write.table(o$K2[,c(1,8)], "gene_lists/K2.forREVIGO.txt",quote=F,col.names=F,row.names=F)
kable(o['K3'])
write.table(o$K3[,c(1,8)], "gene_lists/K3.forREVIGO.txt",quote=F,col.names=F,row.names=F)
kable(o['K4'])
write.table(o$K4[,c(1,8)], "gene_lists/K4.forREVIGO.txt",quote=F,col.names=F,row.names=F)
```
