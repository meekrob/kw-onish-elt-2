...
ap.0 = ap.0[order(ap.0$variance)] # weighted score is always 0, since this group is not clustered
ap.1 = ap.1[order(-ap.1$weightedVariance)]
ap.2 = ap.2[order(-ap.2$weightedVariance)]
ap.3 = ap.3[order(-ap.3$weightedVariance)]
ap.4 = ap.4[order(-ap.4$weightedVariance)]
