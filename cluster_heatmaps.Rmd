...
for (THRESHOLD in THRESHOLDS) {
  ...
  nclust=4
  set.seed(31415)
  label=paste(sprintf("kmeans clusters at std. dev. > %.3f,", threshold_q), "(excluding lower ", sprintf("%.1f%%)", THRESHOLD*100))
  ...
  label=paste(sprintf("Cluster trends at std. dev. > %.3f,", threshold_q), "(excluding lower ", sprintf("%.1f%%)", THRESHOLD*100))
  ...
  #korder = order(kclusters)
  #pheatmap(threshold_x[korder,], cluster_rows=F, cluster_cols=F, show_rownames=F, main=paste("excluding lower",TXT_THRESHOLD, "sd", sep=" "))
  korder = order(reassigned_ks, decreasing=T)
  
  # colorMap
  color = colorRampPalette(rev(brewer.pal(n = 7, name ="RdYlBu")))(100)
  pheatmap(threshold_x[korder,], cluster_rows=F, cluster_cols=F, color=color, show_rownames=F, main=paste("excluding lower",TXT_THRESHOLD, "sd", sep=" "))
