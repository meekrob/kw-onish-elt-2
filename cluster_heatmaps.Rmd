...
L1_IDR.np = makeGRangesFromNarrowPeak('L1_1_L1_2.IDR_0.05.narrowPeak')
LE_IDR.np = makeGRangesFromNarrowPeak('LE_1_LE_2.IDR_0.05.narrowPeak')
L3_IDR.np = makeGRangesFromNarrowPeak('L3_1_L3_2.IDR_0.05.narrowPeak')
...
kremap = data.frame( `k`=1:4, `class`=4:1, `class_roman`=c('IV','III','II','I'), label=c('L3_high','Dev_increasing', 'Larval', 'Embryonic'))
...
barplot(table(clustersPerGene_rowSums), xlab="number of peaks mapped to a gene", ylab="number of genes", main="Genes tend to have a single peak mapped to them")
