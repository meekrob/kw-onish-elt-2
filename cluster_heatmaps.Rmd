...
nclust=4
set.seed(31415)
pobj = pheatmap(threshold_x, kmeans=nclust, cluster_rows=F, cluster_cols = F, main=paste("excluding lower",THRESHOLD, "sd", sep=" "))
...
plot(c(1,3), c(min(patterns),2), type='n', axes=F, main=paste("Cluster centers, excluding lower",THRESHOLD, "sd", sep=" "),xlab = "Stage", ylab="Normalized value")
