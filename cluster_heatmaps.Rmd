...
LE_verify = GenomicRanges::findOverlaps(LE_IDR, dfG, "within")
L1_verify = GenomicRanges::findOverlaps(L1_IDR, dfG, "within")
L3_verify = GenomicRanges::findOverlaps(L3_IDR, dfG, "within")
####
