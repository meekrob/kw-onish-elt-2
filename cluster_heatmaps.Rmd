...
print(
      ggplot(clusters$k4_trends_long, 
          ...
          labs(title="Kmeans cluster centers (k=4)", 
               y = "cluster center (Z)", 
               x = "developmental stage") + 
          figure_colors + facet_grid(description ~ .) + theme_bw() + scale_x_discrete(expand=rep(0,4)))
...
clusters$k11_trends = as.data.frame(clusters$k11_trends)
...
figure_colors = scale_colour_manual(name="cluster Id (size)", values=brewer.pal(11,"Paired"))
print(
