...
ap.tbl.0 %>% arrange(desc(selectionScore)) %>% mutate(rankInCluster = 1:nrow(ap.tbl.0)) -> ap.tbl.scored
ap.tbl.1 %>% arrange(desc(selectionScore)) %>% mutate(rankInCluster = 1:nrow(ap.tbl.1)) %>%
  bind_rows(ap.tbl.scored) -> ap.tbl.scored
ap.tbl.2 %>% arrange(desc(selectionScore)) %>% mutate(rankInCluster = 1:nrow(ap.tbl.2)) %>%
  bind_rows(ap.tbl.scored) -> ap.tbl.scored
ap.tbl.3 %>% arrange(desc(selectionScore)) %>% mutate(rankInCluster = 1:nrow(ap.tbl.3)) %>%
  bind_rows(ap.tbl.scored) -> ap.tbl.scored
ap.tbl.4 %>% arrange(desc(selectionScore)) %>% mutate(rankInCluster = 1:nrow(ap.tbl.4)) %>%
  bind_rows(ap.tbl.scored) -> ap.tbl.scored
