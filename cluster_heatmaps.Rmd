...
k11_explained_variance = clusters$kmeans_on3d_k11$betweenss/clusters$kmeans_on3d_k11$totss
...
print(
  ggplot(k11_trends_long, 
    ...
    labs(title="Kmeans cluster centers (k=11)",
         subtitle=sprintf("%.1f%% variance explained",100*k11_explained_variance),
         y = "cluster center (Z)", 
         x = "developmental stage") + 
