...
# empirical data
feature_table = readRDS("feature_mapping_empirical.tbl")
...
features_observed %>% melt() -> feat_obs_tbl
colnames(feat_obs_tbl) <- c("variable","value")

ggplot(as_tibble(feature_table) %>% melt(), aes(x = value)) + 
