...
xl$old.mapping = ap$feature
xl$new.mapping = stacked_nr$feature
...
xlsFilename="featureMappingCheck_template.xlsx"
mappingXLS = loadWorkbook(xlsFilename, create=T)
sheetname = format(Sys.time(), "%m-%d")
sheetversion=1
sheetnamebase = sheetname
while(existsSheet(mappingXLS, sheetname)) {
  sheetversion = sheetversion + 1
  sheetname = sprintf("%s.%d",sheetnamebase,version)
}
createSheet(mappingXLS, sheetname)

writeWorksheet(mappingXLS, xl, sheetname)
saveWorkbook(mappingXLS)
##
