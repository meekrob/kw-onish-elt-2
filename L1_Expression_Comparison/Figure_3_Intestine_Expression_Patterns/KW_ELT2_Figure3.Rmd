...
```
Export `chip_rna_df` for supp files
```{r}
# write_csv(chip_rna_df, file = "./02_output/FileS3_Intestine-specific_time-resolved_data.csv")
```
...
# write_csv(fig3df, file = "02_output/Fig3_Intestine_Development_Cluster_Assignments.csv")
```
