...
all_elt2_notbound_genes <- 20470 - m # number of genes not bound in the genome
...
rna_cluster_names <- factor(c("One", "Two", "Three", "Four"), levels = c("One", "Four", "Two", "Three"), labels = c("Embryonic", "L1", "Post-embryonic", "Adult"))
# 4. Draw the heatmap
