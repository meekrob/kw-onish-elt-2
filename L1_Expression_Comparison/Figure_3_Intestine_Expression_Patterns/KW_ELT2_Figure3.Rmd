...
View(read.delim("./01_input/9_Boeck_et_al_2016_time-resolved_transcriptome/Unified_dcpm_per_wormbase_gene.txt", quote="", stringsAsFactors=FALSE))
...
chip_rna_matrix <-
  chip_rna_df %>% dplyr::select(emb_44min:YA) %>% as.matrix()
...
genes_list[["C18G1.2"]]
unlist(genes_list[c(rownames(mat[ix,]))])
