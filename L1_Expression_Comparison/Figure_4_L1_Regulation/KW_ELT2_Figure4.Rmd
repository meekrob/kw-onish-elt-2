...
biomaRt::getBM(mart = paramart,attributes = c('wbps_gene_id','external_gene_id'), useCache = FALSE
  )
```


# Make output dataframe
#TODO: USE BIOMART TO TRANSLATE WBGENEID
```{r}
...
all_elt2_summit$class <- factor(all_elt2_summit$class, levels = c("ClassA", "ClassB", "ClassC", "ClassD", "no_class"))
...
export(getSeq(Celegans, elt2_summit_GRange[elementMetadata(elt2_summit_GRange)[,"bound_class"] %in% classnames]), "./02_output/MEME-ChIP_fasta/ClassAthroughD_elt2_summits.fasta")
...
export(getSeq(Celegans, elt2_summit_GRange[elementMetadata(elt2_summit_GRange)[,"bound_class"] %in% 
                                      c("ClassB","ClassC", "ClassD")]),
       "./02_output/MEME-ChIP_fasta/BoundDE_NoClassA_elt2_summits.fasta")
export(getSeq(Celegans, elt2_summit_GRange[elementMetadata(elt2_summit_GRange)[,"bound_class"] %in% 
                                      c("ClassA", "ClassC", "ClassD")]),
       "./02_output/MEME-ChIP_fasta/BoundDE_NoClassB_elt2_summits.fasta")
export(getSeq(Celegans, elt2_summit_GRange[elementMetadata(elt2_summit_GRange)[,"bound_class"] %in% 
                                      c("ClassA", "ClassB", "ClassD")]),
       "./02_output/MEME-ChIP_fasta/BoundDE_NoClassC_elt2_summits.fasta")
export(getSeq(Celegans, elt2_summit_GRange[elementMetadata(elt2_summit_GRange)[,"bound_class"] %in% 
                                      c("ClassA", "ClassB", "ClassC")]),
       "./02_output/MEME-ChIP_fasta/BoundDE_NoClassD_elt2_summits.fasta")
