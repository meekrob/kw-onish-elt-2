 ...
 *
 */
public class CustomEquation_2 extends WigMathTool {

  private static final Logger log = Logger.getLogger(CustomEquation_2.class);
  ...
  @Parameter(names = { "-k", "--constant-min"}, description = "Add a constant", required = true, validateWith = FloatValidator.class)
  public float konstant;


  public boolean assumeZero = true;
  ...
  public float[] compute(Interval chunk) throws IOException, WigFileException {
    ...
    for (int i = 0; i < minuend.length; i++) {
        minuend[i] = minuend[i] - subtrahend[i] + konstant;
    }
    return minuend;
  }
  ...
  public static void main(String[] args) throws IOException, WigFileException {
    new CustomEquation_2().instanceMain(args);
  }
