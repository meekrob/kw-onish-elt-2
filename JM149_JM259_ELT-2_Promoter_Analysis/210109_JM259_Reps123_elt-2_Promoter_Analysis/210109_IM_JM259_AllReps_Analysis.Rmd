---
title: "210109_IM_JM259_AllReps_Analysis"
author: "IRM"
date: "210109"
output:
...
save plot
```{r}
ggsave("210109_JM259_AllReps_ELT-2_RNAi_Development_Series_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("210109_JM259_AllReps_Relative_Promoter_Fluorescence.pdf", width = 6, height = 5)
```
