---
title: "201125_IM_JM149_GFP_Analysis"
author: "IRM"
date: "201125"
output:
...
save plot
```{r}
ggsave("201125_JM149_Rep1_ELT-2_RNAi_Development_Series_Abbreviated_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("201125_JM149_Rep1_Relative_Promoter_Fluorescence_Abbreviated.pdf", width = 6, height = 5)
```
