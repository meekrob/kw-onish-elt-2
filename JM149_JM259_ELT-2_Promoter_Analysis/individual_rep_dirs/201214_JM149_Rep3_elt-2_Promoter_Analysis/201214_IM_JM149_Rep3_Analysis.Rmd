---
title: "201214_IM_JM149_Rep3_Analysis"
author: "IRM"
date: "201214"
output:
...
image_df <- data.frame()
for(sheet in sheets) {
 toappend <- read_excel("./JM149_Rep3_elt-2_Promoter_ImageJ_Analysis.xlsx", sheet = sheet)
...
save plot
```{r}
ggsave("201214_JM149_Rep3_ELT-2_RNAi_Development_Series_Abbreviated_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("201214_JM149_Rep3_Relative_Promoter_Fluorescence_Abbreviated.pdf", width = 6, height = 5)
```
