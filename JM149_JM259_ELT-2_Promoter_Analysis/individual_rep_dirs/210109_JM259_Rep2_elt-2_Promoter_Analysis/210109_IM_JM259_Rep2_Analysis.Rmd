---
title: "210109_IM_JM259_Rep2_Analysis"
author: "IRM"
date: "210109"
output:
...
image_df <- data.frame()
for(sheet in sheets) {
 toappend <- read_excel("./JM259_Rep2_elt-2_Promoter_ImageJ_Analysis.xlsx", sheet = sheet)
...
save plot
```{r}
ggsave("210109_JM259_Rep2_ELT-2_RNAi_Development_Series_Abbreviated_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("210109_JM259_Rep2_Relative_Promoter_Fluorescence_Abbreviated.pdf", width = 6, height = 5)
```
