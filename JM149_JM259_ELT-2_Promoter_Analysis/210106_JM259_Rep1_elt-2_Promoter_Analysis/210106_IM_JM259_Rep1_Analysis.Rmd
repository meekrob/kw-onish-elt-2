---
title: "210106_IM_JM259_Rep1_Analysis"
author: "IRM"
date: "201208"
output:
...
image_df <- data.frame()
for(sheet in sheets) {
 toappend <- read_excel("./JM259_Rep1_elt-2_Promoter_ImageJ_Analysis_FilteredStages.xlsx", sheet = sheet)
...
save plot
```{r}
ggsave("210106_JM259_Rep1_Development_Series_Abrv_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("210106_JM259_Rep1_Relative_Promoter_Fluorescence_Abrv.pdf", width = 6, height = 5)
```
