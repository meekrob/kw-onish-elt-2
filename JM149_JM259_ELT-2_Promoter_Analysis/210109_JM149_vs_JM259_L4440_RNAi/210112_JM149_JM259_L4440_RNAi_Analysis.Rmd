---
title: "210112_JM149_JM259_L4440_RNAi_Analysis"
author: "IRM"
date: "210112"
output:
...
```{r}
sheets <- c("JM149_Rep1_L4440",  "JM149_Rep2_L4440", "JM149_Rep3_L4440",  "JM259_Rep1_L4440", "JM259_Rep2_L4440",  "JM259_Rep3_L4440")


image_df <- data.frame()
for(sheet in sheets) {
 toappend <- read_excel("./JM149_JM259_L4440_RNAi_Analysis.xlsx", sheet = sheet)
...
ggplot(image_ctcf, aes(worm_strain, CTCF)) + 
  ...
  scale_y_log10() +
  labs(
    title = "elt-2 Promoter Fluorescence Intensity L4440 RNAi During Development",
    x = "Worm Strain",
...
save plot
```{r}
ggsave("210112_JM149_JM259_L4440_RNAi_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("210112_JM149_JM259_L4440_RNAi_Relative_Promoter_Fluorescence.pdf", width = 6, height = 5)
```
