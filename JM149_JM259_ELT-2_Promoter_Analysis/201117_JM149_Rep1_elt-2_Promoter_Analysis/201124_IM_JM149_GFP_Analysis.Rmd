---
title: "201124_IM_JM149_GFP_Analysis"
author: "IRM"
date: "201124"
output:
...
save plot
```{r}
ggsave("201124_JM149_ELT-2_RNAi_Development_Series_Abbreviated_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("201124_JM149_Relative_Promoter_Fluorescence_Abbreviated.pdf", width = 4, height = 4)
```
