...
image_df <- data.frame()
for(sheet in sheets) {
 toappend <- read_excel("./JM149_elt-2_Promoter_ImageJ_Analysis_FilteredStages.xlsx", sheet = sheet)
...
save plot
```{r}
ggsave("201119_JM149_ELT-2_RNAi_Development_Series_Abbreviated_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("201119_JM149_Relative_Promoter_Fluorescence_Abbreviated.pdf", width = 4, height = 4)
```
