---
title: "201214_IM_JM149_AllReps_Analysis"
author: "IRM"
date: "201214"
output:
...
save plot
```{r}
ggsave("201214_JM149_AllReps_ELT-2_RNAi_Development_Series_Area_Included.pdf", width = 7.5, height = 5.5)
```
...
```{r}
ggsave("201214_JM149_AllReps_Relative_Promoter_Fluorescence.pdf", width = 6, height = 5)
```
